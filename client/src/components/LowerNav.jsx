...
function LowerNav(props) {
    return(
      <div class="lower-nav">
        <div class="nav-bar-cat" id="shopAll" onMouseOver={props.onAllProducts} onMouseLeave={props.onMouseLeave}>
          Shop All
        ...
        <div class="nav-bar-cat" id="skinCare" onMouseOver={props.onMouseOver} onMouseLeave={props.onMouseLeave}>
          Skincare
        ...
        <div class="nav-bar-cat" id="makeUp" onMouseOver={props.onMouseOver} onMouseLeave={props.onMouseLeave}>
          Makeup
        ...
        <div class="nav-bar-cat" id="body" onMouseOver={props.onMouseOver} onMouseLeave={props.onMouseLeave}>
          Body
        ...
        <div class="nav-bar-cat" id="fragrance" onMouseOver={props.onMouseOver} onMouseLeave={props.onMouseLeave}>
          Fragrance
        ...
        <div class="nav-bar-cat" id="shopOurSets" onMouseOver={props.onMouseOver} onMouseLeave={props.onMouseLeave}>
          Shop our Sets
